...
function startDrag(e) {
    ...
    // Helps keep events routed correctly on some mobile browsers
    if (toolDiv.setPointerCapture && e.pointerId !== undefined) {
        try { toolDiv.setPointerCapture(e.pointerId); } catch (_) {}
    }
...
function drag(e) {
    if (!state.draggedItem || !canvas) return;
    e.preventDefault();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mobile-friendly: pointerup is more reliable than click on some touch browsers
